...
import POMClasess.SwagLabHomePage;
import POMClasess.SwagLabLoginPage;
...
public class SwagLabsLoginSteps {
    ...
    public void user_enter_username_on_swag_lab_login_page(String unvalue) {
        login.inpSwagLabLoginPageUsername(unvalue);

    }

    @When("user enter password on swagLab login page {string}")
    public void user_enter_password_on_swag_lab_login_page(String pwdValue) {
        login.inpSwagLabLoginPagePassword(pwdValue);

    }

    @When("user click on login btn on swagLab login page")
    public void user_click_on_login_btn_on_swag_lab_login_page() {
